...
<button
  type="button"
  onclick={next}
  class="block w-full cursor-pointer rounded-lg border-0 bg-transparent p-0 text-left focus:outline-none focus-visible:ring-2 focus-visible:ring-ribbon/50"
>
